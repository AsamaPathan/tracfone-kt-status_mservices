...
public class TracfoneKTStatusControllerTest {
	  ...
	  private MockMvc mockMvc;
	   ...
	   public void testGetAllKTS() throws Exception {
	       ...
	       mockMvc.perform(get("/api/v1/tracfone/kt/ktDomain")).andExpect(status().isOk()).andExpect(jsonPath("$", Matchers.hasSize(1)))
	   ...
	   public void testaddKTDomain() throws Exception {
	        ...
	        mockMvc.perform(post("/api/v1/tracfone/kt/ktDomain").contentType(MediaType.APPLICATION_JSON).characterEncoding("utf-8")
	   ...
	   public void testUpdateKTStatus() throws Exception {
	       ...
	       mockMvc.perform(post("/api/v1/tracfone/kt/ktStatus").contentType(MediaType.APPLICATION_JSON).characterEncoding("utf-8")
	                .content(json).accept(MediaType.APPLICATION_JSON)).andExpect(status().isOk());
	    }
}
